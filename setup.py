...
with open("src/prompt_toolkit_table/version.py") as fp:
...
setup(
    name="prompt-toolkit-table",
    version=version,
    description="Table implementation for the Python Prompt Toolkit library",
    author="Lyz",
    author_email="lyz-code-security-advisories@riseup.net",
    license="GNU General Public License v3",
    long_description=readme,
    long_description_content_type="text/markdown",
    url="https://github.com/lyz-code/prompt-toolkit-table",
    packages=find_packages("src"),
    package_dir={"": "src"},
    package_data={"prompt_toolkit_table": ["py.typed"]},
